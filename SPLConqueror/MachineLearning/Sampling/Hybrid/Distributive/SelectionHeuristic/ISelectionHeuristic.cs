...
namespace MachineLearning.Sampling.Hybrid.Distributive.SelectionHeuristic
{
    ...
    public interface ISelectionHeuristic
    {
        ...
        List<Configuration> SampleFromDistribution(Dictionary<double, double> wantedDistribution, List<double> allBuckets, int count, List<BinaryOption> desiredOptions, Optimization optimization);
    }
}
