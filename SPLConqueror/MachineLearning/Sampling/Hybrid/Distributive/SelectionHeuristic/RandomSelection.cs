...
namespace MachineLearning.Sampling.Hybrid.Distributive.SelectionHeuristic
{
    public class RandomSelection : ISelectionHeuristic
    {
        ...
        public List<Configuration> SampleFromDistribution(Dictionary<double, double> wantedDistribution, List<double> allBuckets, int count, List<BinaryOption> whiteList, Optimization optimization)
        {
