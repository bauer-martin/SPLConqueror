...
namespace MachineLearning.Sampling.Hybrid.Distributive
{
    ...
    public abstract class DistributionSensitive : HybridStrategy
    {
        ...
        public override bool ComputeSamplingStrategy(List<BinaryOption> desiredOptions)
        {
            ...
            SampleFromDistribution(wholeDistribution, allBuckets, numberConfigs, desiredOptions);
        ...
        public void SampleFromDistribution(Dictionary<double, List<Configuration>> wholeDistribution, List<double> allBuckets, int count, List<BinaryOption> desiredOptions)
        {
            ...
            this.selectedConfigurations = selection
                .SampleFromDistribution(wantedDistribution, allBuckets, count, desiredOptions, GetOptimization());
        }
