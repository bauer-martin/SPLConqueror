...
namespace MachineLearning.Solver
{
    public interface IVariantGenerator
    {
        ...
        List<Configuration> GenerateAllVariants(List<ConfigurationOption> optionsToConsider);
        ...
        List<List<BinaryOption>> GenerateUpToN(int n);
        ...
        List<BinaryOption> FindMinimizedConfig(List<BinaryOption> config, List<BinaryOption> unWantedOptions);
        ...
        List<List<BinaryOption>> FindAllMaximizedConfigs(List<BinaryOption> config, List<BinaryOption> unwantedOptions);
        ...
        List<BinaryOption> GenerateConfigWithoutOption(BinaryOption optionToBeRemoved, List<BinaryOption> originalConfig, out List<BinaryOption> removedElements);
